frappe.ui.form.on('Quotation', {
    refresh(frm) {
        ...
        frm.add_custom_button(__("Repair Order"), function(){
            erpnext.utils.map_current_doc({
                method: "catalog.catalog.doctype.repair_order.repair_order.make_quotation",
...
frappe.ui.form.on('Quotation Item', {
    ...
    edit_bom: function (frm, cdt, cdn) {
        ...
        const finding_fields = [
            { fieldtype: 'Data', fieldname: "docname", read_only: 1, hidden: 1 },
            { fieldtype: 'Link', fieldname: "metal_type", columns: 1, label: __('Metal Type'), reqd: 1, in_list_view: 1, options: "Attribute Value", get_query() { return { query: 'jewellery_erpnext.query.item_attribute_query', filters: { 'item_attribute': 'Metal Type' } } } },
