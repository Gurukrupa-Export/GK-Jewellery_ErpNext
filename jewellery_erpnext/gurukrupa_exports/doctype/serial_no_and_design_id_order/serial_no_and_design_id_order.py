...
def make_quotation(source_name, target_doc=None):
	...
	snd_order = frappe.db.get_value("Serial No and Design ID Order", source_name, "*")
	...
	target_doc.append("items", {
		...
		"metal_color": snd_order.get("metal_colour"),
		...
		"order_form_type": "Serial No and Design ID Order",
		"order_form_id": snd_order.get("name"),
		"salesman_name": snd_order.get("salesman_name"),
		"order_form_date": snd_order.get("order_date"),
		"po_no": snd_order.get("po_number"),
		"parcel_place": snd_order.get("parcel_place")
	})
